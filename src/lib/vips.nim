...
type VipsRelational* {.
  importc: "VipsRelational", header: "vips/vips.h", size: sizeof(cint)
.} = enum
...
proc g_object_ref*(
  obj: pointer
): pointer {.importc: "g_object_ref", header: "glib-object.h".}
...
proc vips_image_new*(): ptr VipsImage {.
  importc: "vips_image_new", header: "vips/vips.h"
.}
...
proc vips_image_new_from_memory*(
  data: pointer,
  size: csize_t,
  width: cint,
  height: cint,
  bands: cint,
  format: VipsFormat,
): ptr VipsImage {.importc: "vips_image_new_from_memory", header: "vips/vips.h".}

proc vips_image_new_from_memory_copy*(
  data: pointer,
  size: csize_t,
  width: cint,
  height: cint,
  bands: cint,
  format: VipsFormat,
): ptr VipsImage {.importc: "vips_image_new_from_memory_copy", header: "vips/vips.h".}

proc vips_image_get_width*(
  image: ptr VipsImage
): cint {.importc: "vips_image_get_width", header: "vips/vips.h".}

proc vips_image_get_height*(
  image: ptr VipsImage
): cint {.importc: "vips_image_get_height", header: "vips/vips.h".}

proc vips_image_get_bands*(
  image: ptr VipsImage
): cint {.importc: "vips_image_get_bands", header: "vips/vips.h".}

proc vips_image_get_format*(
  image: ptr VipsImage
): VipsFormat {.importc: "vips_image_get_format", header: "vips/vips.h".}

proc vips_image_get_interpretation*(
  image: ptr VipsImage
): VipsInterpretation {.
...
proc vips_maplut*(
  input: ptr VipsImage, output: ptr ptr VipsImage, lut: ptr VipsImage, args: pointer
): cint {.importc: "vips_maplut", header: "vips/vips.h".}
...
proc vips_hist_find*(
  input: ptr VipsImage, output: ptr ptr VipsImage, args: pointer
): cint {.importc: "vips_hist_find", header: "vips/vips.h".}

proc vips_hist_find_indexed*(
  input: ptr VipsImage, output: ptr ptr VipsImage, index: ptr VipsImage, args: pointer
): cint {.importc: "vips_hist_find_indexed", header: "vips/vips.h".}

proc vips_getpoint*(
  image: ptr VipsImage, vector: ptr cdouble, x: cint, y: cint, args: pointer
): cint {.importc: "vips_getpoint", header: "vips/vips.h".}

proc vips_add*(
  left: ptr VipsImage, right: ptr VipsImage, output: ptr ptr VipsImage, args: pointer
): cint {.importc: "vips_add", header: "vips/vips.h".}

proc vips_subtract*(
  left: ptr VipsImage, right: ptr VipsImage, output: ptr ptr VipsImage, args: pointer
): cint {.importc: "vips_subtract", header: "vips/vips.h".}

proc vips_multiply*(
  left: ptr VipsImage, right: ptr VipsImage, output: ptr ptr VipsImage, args: pointer
): cint {.importc: "vips_multiply", header: "vips/vips.h".}

proc vips_add_const*(
  input: ptr VipsImage,
  output: ptr ptr VipsImage,
  c: ptr cdouble,
  n: cint,
  args: pointer,
): cint {.importc: "vips_linear", header: "vips/vips.h".}
  # Note: vips_add_const is deprecated

proc vips_multiply_const*(
  input: ptr VipsImage,
  output: ptr ptr VipsImage,
  c: ptr cdouble,
  n: cint,
  args: pointer,
): cint {.importc: "vips_linear", header: "vips/vips.h".} # Use vips_linear instead
...
proc vips_relational*(
  left: ptr VipsImage,
  right: ptr VipsImage,
  output: ptr ptr VipsImage,
  relational: VipsRelational,
  args: pointer,
): cint {.importc: "vips_relational", header: "vips/vips.h".}

proc vips_relational_const*(
  input: ptr VipsImage,
  output: ptr ptr VipsImage,
  relational: VipsRelational,
  c: ptr cdouble,
  n: cint,
  args: pointer,
): cint {.importc: "vips_relational_const", header: "vips/vips.h".}
...
proc vips_boolean*(
  ...
  boolean: cint,
  args: pointer,
): cint {.importc: "vips_boolean", header: "vips/vips.h".}

proc vips_ifthenelse*(
  cond: ptr VipsImage,
  input1: ptr VipsImage,
  input2: ptr VipsImage,
  output: ptr ptr VipsImage,
  args: pointer,
): cint {.importc: "vips_ifthenelse", header: "vips/vips.h".}
...
proc vips_icc_transform*(
  input: ptr VipsImage,
  output: ptr ptr VipsImage,
  output_profile: cstring,
  args: pointer,
): cint {.importc: "vips_icc_transform", header: "vips/vips.h".}

proc vips_avg*(
  input: ptr VipsImage, output: ptr cdouble, args: pointer
): cint {.importc: "vips_avg", header: "vips/vips.h".}

proc vips_min*(
  input: ptr VipsImage, output: ptr cdouble, args: pointer
): cint {.importc: "vips_min", header: "vips/vips.h".}

proc vips_max*(
  input: ptr VipsImage, output: ptr cdouble, args: pointer
): cint {.importc: "vips_max", header: "vips/vips.h".}

proc vips_image_set_int*(
  image: ptr VipsImage, name: cstring, i: cint
) {.importc: "vips_image_set_int", header: "vips/vips.h".}

proc vips_image_get_int*(
  image: ptr VipsImage, name: cstring, output: ptr cint
): cint {.importc: "vips_image_get_int", header: "vips/vips.h".}

proc vips_malloc*(
  size: csize_t
): pointer {.importc: "vips_malloc", header: "vips/vips.h".}

proc vips_error_buffer*(): cstring {.
  importc: "vips_error_buffer", header: "vips/vips.h"
.}
